...
var ProductDetailComponent = /** @class */ (function () {
    ...
    ProductDetailComponent.prototype.onProductRetrieved = function (product) {
...
var ProductEditInfoComponent = /** @class */ (function () {
    ...
    ProductEditInfoComponent.prototype.ngOnInit = function () {
        ...
        this.route.parent.data.subscribe(function (data) {
            ...
            _this.product = data['resolvedData'].product;
        });
    };
    ProductEditInfoComponent.ctorParameters = function () { return [
        { type: _angular_router__WEBPACK_IMPORTED_MODULE_2__["ActivatedRoute"] }
    ]; };
...
var ProductEditTagsComponent = /** @class */ (function () {
    ...
    ProductEditTagsComponent.ctorParameters = function () { return [
        { type: _angular_router__WEBPACK_IMPORTED_MODULE_2__["ActivatedRoute"] }
    ]; };
...
var ProductEditComponent = /** @class */ (function () {
    ...
    Object.defineProperty(ProductEditComponent.prototype, "product", {
        ...
        set: function (value) {
            ...
            this.originalProduct = tslib__WEBPACK_IMPORTED_MODULE_0__["__assign"]({}, value);
        },
        enumerable: true,
        configurable: true
    });
    ProductEditComponent.prototype.ngOnInit = function () {
        ...
        this.route.data.subscribe(function (data) {
            ...
            _this.errorMessage = resolvedData.error;
            _this.onProductRetrieved(resolvedData.product);
        });
    };
        ...
        if (this.product.id === 0) {
            ...
            if (confirm("Really delete the product: " + this.product.productName + "?")) {
                this.productService.deleteProduct(this.product.id).subscribe({
                    next: function () { return _this.onSaveComplete(_this.product.productName + " was deleted"); },
        ...
        if (this.isValid()) {
            if (this.product.id === 0) {
                this.productService.createProduct(this.product).subscribe({
                    next: function () { return _this.onSaveComplete("The new " + _this.product.productName + " was saved"); },
                    error: function (err) { return _this.errorMessage = err; }
                });
            }
            else {
                this.productService.updateProduct(this.product).subscribe({
                    next: function () { return _this.onSaveComplete("The updated " + _this.product.productName + " was saved"); },
                    error: function (err) { return _this.errorMessage = err; }
                });
            }
        }
    ...
    ProductListComponent.prototype.ngOnInit = function () {
        ...
        this.productService.getProducts().subscribe({
            next: function (products) {
                ...
                _this.filteredProducts = _this.performFilter(_this.listFilter);
            },
            error: function (err) { return _this.errorMessage = err; }
        });
    };
...
var ProductResolver = /** @class */ (function () {
    ...
    ProductResolver.prototype.resolve = function (route, state) {
        ...
        if (isNaN(+id)) {
            var message = "Product id was not a number: " + id;
            console.error(message);
            return Object(rxjs__WEBPACK_IMPORTED_MODULE_2__["of"])({ product: null, error: message });
        }
        return this.productService.getProduct(+id)
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(function (product) { return ({ product: product }); }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["catchError"])(function (error) {
...
var ProductService = /** @class */ (function () {
    ...
    ProductService.prototype.getProduct = function (id) {
        ...
        return this.http.get(url)
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["tap"])(function (data) { return console.log('getProduct: ' + JSON.stringify(data)); }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(this.handleError));
    };
    ProductService.prototype.createProduct = function (product) {
        ...
        return this.http.post(this.productsUrl, product, { headers: headers })
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["tap"])(function (data) { return console.log('createProduct: ' + JSON.stringify(data)); }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(this.handleError));
    };
    ProductService.prototype.deleteProduct = function (id) {
        var headers = new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpHeaders"]({ 'Content-Type': 'application/json' });
        var url = this.productsUrl + "/" + id;
        return this.http.delete(url, { headers: headers })
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["tap"])(function (data) { return console.log('deleteProduct: ' + id); }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(this.handleError));
    };
    ProductService.prototype.updateProduct = function (product) {
        var headers = new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpHeaders"]({ 'Content-Type': 'application/json' });
        var url = this.productsUrl + "/" + product.id;
        return this.http.put(url, product, { headers: headers })
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["tap"])(function () { return console.log('updateProduct: ' + product.id); }), 
        // Return the product on an update
        Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["map"])(function () { return product; }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(this.handleError));
    };
